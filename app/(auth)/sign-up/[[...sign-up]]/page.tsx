...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Optional: Validate firstName and lastName if you want
    // For example:
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({
          email,
          username,
          password, // Backend should hash this as passwordHash
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-purple-700 via-purple-900 to-black px-6 py-12 overflow-hidden">
